...
function HelpCategory({ icon, title, description }: { icon: IconDefinition; title: string; description: string }) {
    return (
    ...
    const faqs = [
        {
            ...
            answer: 'You can track your order by going to "My Orders" in your profile. Each order has a tracking number that you can use to monitor delivery status.',
        },
        {
            question: 'What is your return policy?',
            answer: 'We offer a 30-day return policy for most items. Products must be unused and in original packaging. Some items like personalized products may not be eligible for returns.',
        },
        {
            question: 'How do I change my shipping address?',
            answer: 'You can manage your addresses in "Addresses" under your profile. To change the address for an existing order, please contact our support team within 24 hours of placing the order.',
        },
        {
        ...
        },
        {
            ...
            answer: 'You can enter your coupon code on the cart page before checkout. Look for the "Have a coupon?" section and enter your code there.',
        },
        {
            question: 'My order arrived damaged. What should I do?',
            answer: 'We apologize for any inconvenience. Please contact our support team within 48 hours with photos of the damaged item. We will arrange a replacement or refund.',
        },
    ];
