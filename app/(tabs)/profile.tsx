    ...
    return (
        <SafeAreaView style={styles.container} edges={['top']}>
            ...
            <View style={styles.quickActions}>
                ...
                <MenuItem icon={faShoppingCart} title='View Cart' subtitle='Check your shopping cart' onPress={() => router.push('/cart')} />
                <MenuItem icon={faHeart} title='Wishlist' subtitle="Items you've saved" onPress={() => router.push('/wishlist')} />
                <MenuItem icon={faSearch} title='Browse Products' subtitle='Explore our catalog' onPress={() => router.push('/products')} />
            </View>
        </SafeAreaView>
    );
}
        ...
        <SafeAreaView style={styles.container} edges={['top']}>
            <ScrollView showsVerticalScrollIndicator={false}>
                ...
                <View style={styles.menuSection}>
                    ...
                    <MenuItem icon={faShoppingCart} title='Shopping Cart' subtitle={`${cartItemCount} items`} onPress={() => router.push('/cart')} />
                </View>
