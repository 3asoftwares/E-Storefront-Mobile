          ...
          <>
            ...
            <View style={styles.section}>
              ...
              <SecurityMenuItem
                ...
                onPress={() =>
                  Alert.alert('Coming Soon', 'Login activity will be available in a future update')
                }
              />
            </View>
            ...
            <View style={styles.infoCard}>
              ...
              <Text style={styles.infoText}>
                We use industry-standard encryption to protect your data. Your password is never
