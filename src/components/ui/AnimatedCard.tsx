...
export function AnimatedCard({
    ...
    const cardStyle = [styles.card, getVariantStyle(), { padding: getPaddingValue(), borderRadius: getBorderRadius() }, style];
    ...
    if (onPress) {
        return (
            <Animated.View style={animatedStyle}>
                <Pressable onPress={onPress} onPressIn={handlePressIn} onPressOut={handlePressOut} style={cardStyle}>
                    {children}
                </Pressable>
            </Animated.View>
        );
