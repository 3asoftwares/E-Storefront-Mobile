...
describe('GradientHeader Component', () => {
  describe('Title and Subtitle', () => {
    ...
    it('renders subtitle', () => {
      const { getByText } = render(<GradientHeader title="Products" subtitle="All items" />);
      expect(getByText('Products')).toBeTruthy();
  ...
  describe('Back Button', () => {
    it('shows back button when showBack is true', () => {
      ...
      const { UNSAFE_root } = render(<GradientHeader title="Details" showBack onBack={onBack} />);
      expect(UNSAFE_root).toBeTruthy();
    });

    it('calls onBack when back button pressed', () => {
      const onBack = jest.fn();
      const { getByText } = render(<GradientHeader title="Details" showBack onBack={onBack} />);
  ...
  describe('Notification Button', () => {
    it('renders notification button when showNotification is true', () => {
      ...
      const { getByText } = render(
        <GradientHeader title="Home" showNotification onNotification={onNotification} />
      );
    ...
    it('shows notification count badge', () => {
      const { getByText } = render(
        <GradientHeader title="Home" showNotification notificationCount={5} />
      );
    ...
    it('shows 99+ for notification count over 99', () => {
      const { getByText } = render(
        <GradientHeader title="Home" showNotification notificationCount={150} />
      );
    ...
    it('does not show badge when count is 0', () => {
      const { queryByText, getByText } = render(
        <GradientHeader title="Home" showNotification notificationCount={0} />
      );
      expect(getByText('Home')).toBeTruthy();
  ...
  describe('Menu Button', () => {
    it('renders menu button when showMenu is true', () => {
      ...
      const { getByText } = render(<GradientHeader title="Settings" showMenu onMenu={onMenu} />);
  ...
  describe('Variants', () => {
    it('renders gradient variant', () => {
      const { getByText } = render(<GradientHeader title="Gradient" variant="gradient" />);
      expect(getByText('Gradient')).toBeTruthy();
    });

    it('renders solid variant', () => {
      const { getByText } = render(<GradientHeader title="Solid" variant="solid" />);
      expect(getByText('Solid')).toBeTruthy();
    });

    it('renders transparent variant', () => {
      const { getByText } = render(<GradientHeader title="Transparent" variant="transparent" />);
  ...
  describe('Custom Props', () => {
    it('accepts custom gradient colors', () => {
      const { getByText } = render(
        <GradientHeader title="Custom" gradientColors={['#FF0000', '#00FF00']} />
      );
    ...
    it('accepts custom style', () => {
      const { getByText } = render(
        <GradientHeader title="Styled" style={{ paddingHorizontal: 20 }} />
      );
    ...
    it('renders right content', () => {
      const { getByText } = render(
        <GradientHeader title="With Right" rightContent={<Text>Custom Right</Text>} />
      );
